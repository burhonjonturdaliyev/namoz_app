...
import '18_Ruku_Shom.dart';

class Qiyom_shom_3 extends StatefulWidget {
  const Qiyom_shom_3({super.key});

  @override
  State<Qiyom_shom_3> createState() => _Qiyom_shom_3State();
}

class _Qiyom_shom_3State extends State<Qiyom_shom_3> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_shom_3()));
                },
                onPrevPressed: () {
