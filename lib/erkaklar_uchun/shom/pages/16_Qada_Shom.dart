...
import '17_Qiyom_Shom.dart';

class Qada_shom extends StatefulWidget {
  const Qada_shom({super.key});

  @override
  State<Qada_shom> createState() => _Qada_shomState();
}

class _Qada_shomState extends State<Qada_shom> {
  @override
