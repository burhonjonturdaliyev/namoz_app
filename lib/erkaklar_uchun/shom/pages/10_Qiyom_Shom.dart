...
import '11_Ruku_Shom.dart';

class Qiyom_shom_2 extends StatefulWidget {
  const Qiyom_shom_2({super.key});

  @override
  State<Qiyom_shom_2> createState() => _Qiyom_shom_2State();
}

class _Qiyom_shom_2State extends State<Qiyom_shom_2> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_shom_2()));
                },
                onPrevPressed: () {
