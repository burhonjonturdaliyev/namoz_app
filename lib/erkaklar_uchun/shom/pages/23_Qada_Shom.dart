...
class Qada_shom_2 extends StatefulWidget {
  const Qada_shom_2({super.key});

  @override
  State<Qada_shom_2> createState() => _Qada_shom_2State();
}

class _Qada_shom_2State extends State<Qada_shom_2> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "23. Qa'da")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Salom_shom()));
              },
              onPrevPressed: () {
