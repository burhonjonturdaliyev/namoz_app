...
class Qada_asr_2 extends StatefulWidget {
  const Qada_asr_2({super.key});

  @override
  State<Qada_asr_2> createState() => _Qada_asr_2State();
}

class _Qada_asr_2State extends State<Qada_asr_2> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "29. Qa'da")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => Salom_asr()));
              },
              onPrevPressed: () {
