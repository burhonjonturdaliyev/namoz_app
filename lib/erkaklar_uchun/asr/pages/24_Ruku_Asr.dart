...
import '25_Qavma_Asr.dart';

class Ruku_asr_4 extends StatelessWidget {
  const Ruku_asr_4({super.key});
          ...
          Container(
            ...
            child: Padding(
              ...
              child: ListView(
                children: [
                  Row(
                    children: [Bold_style(text: "24. Ruku")],
                  ),
                  SizedBox(
                    height: 10,
                  ),
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Qavma_asr_4()));
              },
              onPrevPressed: () {
