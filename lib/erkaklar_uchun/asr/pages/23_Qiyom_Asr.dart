...
class Qiyom_asr_4 extends StatefulWidget {
  const Qiyom_asr_4({super.key});

  @override
  State<Qiyom_asr_4> createState() => _Qiyom_asr_4State();
}

class _Qiyom_asr_4State extends State<Qiyom_asr_4> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "23. 4-chi rakat. Qiyom")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_asr_4()));
                },
                onPrevPressed: () {
