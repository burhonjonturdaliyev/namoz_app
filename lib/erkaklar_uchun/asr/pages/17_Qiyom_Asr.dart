...
import '18_Ruku_Asr.dart';

class Qiyom_asr_3 extends StatefulWidget {
  const Qiyom_asr_3({super.key});

  @override
  State<Qiyom_asr_3> createState() => _Qiyom_asr_3State();
}

class _Qiyom_asr_3State extends State<Qiyom_asr_3> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_asr_3()));
                },
                onPrevPressed: () {
