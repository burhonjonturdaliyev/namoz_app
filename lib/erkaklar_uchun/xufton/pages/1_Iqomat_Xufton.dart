...
class Iqomat_xufton extends StatelessWidget {
  const Iqomat_xufton({super.key});
          ...
          child: ListView(children: [
            ...
            Row(
              children: [
                Info_style(
                    text:
                        "Xufton namozining to'rt rakat farzi quyidagicha o'qiladi:")
              ],
            ),
            SizedBox(
              height: 10,
        ...
        NavigationContainer(
            ...
            onNextPressed: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => Niyat_xufton()));
            },
            onPrevPressed: null)
      ]),
    );
