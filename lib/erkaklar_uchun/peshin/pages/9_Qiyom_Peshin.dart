...
import '10_Ruku_Peshin.dart';

class Qiyom_peshin_2 extends StatefulWidget {
  const Qiyom_peshin_2({super.key});

  @override
  State<Qiyom_peshin_2> createState() => _Qiyom_peshin_2State();
}

class _Qiyom_peshin_2State extends State<Qiyom_peshin_2> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_peshin_2()));
                },
                onPrevPressed: () {
