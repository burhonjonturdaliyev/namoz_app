...
class Qiyom_peshin_3 extends StatefulWidget {
  const Qiyom_peshin_3({super.key});

  @override
  State<Qiyom_peshin_3> createState() => _Qiyom_peshin_3State();
}

class _Qiyom_peshin_3State extends State<Qiyom_peshin_3> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_peshin_3()));
                },
                onPrevPressed: () {
