...
import 'package:namoz_app/erkaklar_uchun/peshin/pages/29_Salom_Peshin.dart';
...
class Qada_peshin_2 extends StatefulWidget {
  const Qada_peshin_2({super.key});

  @override
  State<Qada_peshin_2> createState() => _Qada_peshin_2State();
}

class _Qada_peshin_2State extends State<Qada_peshin_2> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "28. Qa'da")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
                    ...
                    Row(
                      children: [
                        Info_style(
                            text:
                                "qa'dada o'tiriladi va «Attahiyat», «Salovat» va «Robbana» duolari o'qiladi:")
                      ],
                    ),
                    SizedBox(height: 10),
                    Hiden_context(
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Salom_peshin()));
              },
              onPrevPressed: () {
