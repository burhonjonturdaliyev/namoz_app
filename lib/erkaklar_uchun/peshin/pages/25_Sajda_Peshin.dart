...
class Sajda_peshin_7 extends StatelessWidget {
  const Sajda_peshin_7({super.key});
              ...
              child: ListView(
                children: [
                  Row(
                    ...
                    children: [Bold_style(text: "25. Sajda")],
                  ),
                  SizedBox(
                    height: 10,
                  ),
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Jalsa_peshin_4()));
              },
              onPrevPressed: () {
