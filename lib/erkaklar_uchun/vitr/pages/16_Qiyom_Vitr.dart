...
import '17_Takbir_Vitr.dart';

class Qiyom_vitr_3 extends StatefulWidget {
  const Qiyom_vitr_3({super.key});

  @override
  State<Qiyom_vitr_3> createState() => _Qiyom_vitr_3State();
}

class _Qiyom_vitr_3State extends State<Qiyom_vitr_3> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "16. 3-chi rakat. Qiyom")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
