...
class Qiyom_vitr extends StatefulWidget {
  const Qiyom_vitr({super.key});

  @override
  State<Qiyom_vitr> createState() => _Qiyom_vitrState();
}

class _Qiyom_vitrState extends State<Qiyom_vitr> {
  @override
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_vitr()));
                },
                onPrevPressed: () {
