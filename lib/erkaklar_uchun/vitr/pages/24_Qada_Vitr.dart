...
class Qada_vitr_2 extends StatefulWidget {
  const Qada_vitr_2({super.key});

  @override
  State<Qada_vitr_2> createState() => _Qada_vitr_2State();
}

class _Qada_vitr_2State extends State<Qada_vitr_2> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "24. Qa'da")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
          ...
          NavigationContainer(
              ...
              onNextPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Salom_vitr()));
              },
              onPrevPressed: () {
