...
import '10_Ruku_Vitr.dart';

class Qiyom_vitr_2 extends StatefulWidget {
  const Qiyom_vitr_2({super.key});

  @override
  State<Qiyom_vitr_2> createState() => _Qiyom_vitr_2State();
}

class _Qiyom_vitr_2State extends State<Qiyom_vitr_2> {
  @override
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [Bold_style(text: "9. 2-chi rakat. Qiyom")],
                    ),
                    SizedBox(
                      height: 10,
                    ),
                    ...
                    RichText(
                      ...
                      TextSpan(
                          text:
                              "deb qiyomga (tikka) turilib, Fotiha surasi va bir zam sura o'qiladi.",
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 16,
                          )),
            ...
            NavigationContainer(
                ...
                onNextPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Ruku_vitr_2()));
                },
                onPrevPressed: () {
