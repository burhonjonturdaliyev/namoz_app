...
import 'package:namoz_app/erkaklar_uchun/qazo_namoz/qazo_namoz.dart';
import 'package:namoz_app/erkaklar_uchun/shom/Modul/Modul_Shom.dart';
import 'package:namoz_app/erkaklar_uchun/vitr/Modul/Modul_Vitr.dart';
import 'package:namoz_app/erkaklar_uchun/xufton/Modul/Modul_Xufton.dart';
          ...
          child: Column(
            children: [
              ...
              InkWell(
                ...
                onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Modul_Xufton())),
              ),
              const SizedBox(
                height: 10,
              ),
              InkWell(
                ...
                onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Modul_Vitr())),
              ),
              const SizedBox(
                height: 10,
              ),
              InkWell(
                ...
                onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => const Qazo_namozlar())),
              ),
            ],
          ),
        )
